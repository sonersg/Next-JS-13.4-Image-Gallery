...
function SearchPage() {
    ...
    return (
        <div>
            <Alert>
                This page fetches data on <strong>client side</strong> in order
                to not leak API credentials, the request is sent to a NextJS{" "}
            ...
            <div className="d-flex flex-column align-items-center">
                ...
                {searchResultsLoadingIsError && (
                    <p>
                        Something went wrong. Please, am begging u, try again.
                    </p>
                )}
